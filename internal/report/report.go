...
<div class="container">
  ...
  <h2>All Devices</h2>
  <p style="margin-bottom:1rem;color:#475569;font-size:.85rem">Vendor labels are derived from MAC OUI lookup. They indicate what the OUI registry assigns the address block to — not a confirmed identification of the physical device. MAC addresses can be spoofed and OUI assignments can be reused after revocation.</p>
  ...
  <div class="device-card risk-{{.RiskClass}}">
    ...
    <div class="card-body">
      <dl class="device-meta">
        ...
        <div><dt>Vendor (per MAC OUI)</dt><dd>{{.Vendor}}</dd></div>
  ...
  <h2>Important &mdash; Not Legal Advice</h2>
  <div class="legal">
    <p class="legal-lead">This report is generated by an unaffiliated tool, provided AS IS, with no warranty and no liability (per the MIT license under which SafeStay is distributed). It is not legal advice.</p>
    <ul>
